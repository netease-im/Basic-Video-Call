...
/** @fn void nim_talk_recall_msg2(const char *json_msg, const char *notify, const char *apnstext, const char *pushpayload,const char *json_extension, nim_talk_recall_msg_func cb, const void *user_data);
  * 撤回消息
  * @param[in] json_msg		消息体Json string (Keys SEE MORE `nim_talk_def.h` 『消息结构 Json Keys』)
  * @param[in] notify		自定义通知
