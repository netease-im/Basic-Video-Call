...
<table>
  ...
  <tr>
    <td> \ref nertc::IRtcEngineEx::updateSpatializerAudioRecvRange "updateSpatializerAudioRecvRange"</td>
  ...
  <tr>
    <td> \ref nertc::IRtcEngineEx::updateSpatializerSelfPosition "updateSpatializerSelfPosition"</td>
