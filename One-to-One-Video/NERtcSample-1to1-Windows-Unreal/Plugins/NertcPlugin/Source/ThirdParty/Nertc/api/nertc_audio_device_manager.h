 ...
 * @endif
 * */
NERTC_API struct nertc_device_collection* NERTC_CALL nertc_audio_device_manager_enumerate_record_devices(struct nertc_audio_device_manager* self);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_set_record_device(struct nertc_audio_device_manager* self,const char* device_id);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_get_record_device(struct nertc_audio_device_manager* self, char* device_id);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API struct nertc_device_collection* NERTC_CALL nertc_audio_device_manager_enumerate_playout_devices(struct nertc_audio_device_manager* self);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_set_playout_device(struct nertc_audio_device_manager* self,const char* device_id);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_get_playout_device(struct nertc_audio_device_manager* self,char* device_id);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_set_record_device_volume(struct nertc_audio_device_manager* self,uint32_t volume);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_get_record_device_volume(struct nertc_audio_device_manager* self,uint32_t* volume);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_set_playout_device_volume(struct nertc_audio_device_manager* self,uint32_t volume);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_get_playout_device_volume(struct nertc_audio_device_manager* self,
                                                                              uint32_t* volume);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_set_playout_device_mute(struct nertc_audio_device_manager* self, bool mute);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_get_playout_device_mute(struct nertc_audio_device_manager* self,bool* mute);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_set_record_device_mute(struct nertc_audio_device_manager* self, bool mute);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_get_record_device_mute(struct nertc_audio_device_manager* self, bool* mute);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_start_record_device_test(struct nertc_audio_device_manager *self, uint64_t indication_interval);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_stop_record_device_test(struct nertc_audio_device_manager* self);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_start_playout_device_test(struct nertc_audio_device_manager* self,const char* test_audio_file_path);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_stop_playout_device_test(struct nertc_audio_device_manager* self);
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_start_audio_device_loopback_test(struct nertc_audio_device_manager* self,uint64_t indication_interval);
/**
 * @if English
 ...
 * @endif
 * */
NERTC_API int NERTC_CALL nertc_audio_device_manager_stop_audio_device_loopback_test(struct nertc_audio_device_manager* self);

NERTC_END_DECLS

#endif //NERTC_AUDIO_DEVICE_MANAGER_H
