 ...
 * @endif
 */
struct nertc_pre_decode_video_info {
  /**
   * @if English
 ...
 * @endif
 */
struct nertc_pre_decode_audio_info {
  /* @if English
 ...
 * @endif
 */
struct nertc_pre_decode_frame_info {
  /**
   * @if English
   * The pre decode media type.
   * @endif
   ...
   * @endif
   */
  nertc_pre_decode_media_type media_type;
  /**
   * @if English
   * User id.
   * @endif
   ...
   * @endif
   */
  nertc_pre_decode_video_info video_info;
  /**
   * @if English
   ...
   * @endif
   */
  nertc_pre_decode_audio_info audio_info;
};
 ...
 * @endif
 */
struct nertc_pre_decode_frame_observer {
  void* self;
  /**
   * @if English
   ...
   * @if Chinese
   * 解码前媒体数据回调。
   * - 调用 \ref nertc::IRtcEngineEx::setPreDecodeObserver "setPreDecodeObserver"
   ...
   * @endif
   */
  void (NERTC_CALL *on_frame)(void* self, struct nertc_pre_decode_frame_info* pre_decode_frame);
};
