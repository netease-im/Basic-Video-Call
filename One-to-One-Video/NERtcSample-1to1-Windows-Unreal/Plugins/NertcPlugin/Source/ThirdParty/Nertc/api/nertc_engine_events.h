#ifndef NERTC_ENGINE_EVENTS_H
#define NERTC_ENGINE_EVENTS_H
...
struct nertc_engine_events {
    ...
    * @endif
    */
    void (NERTC_CALL *on_api_call_executed)(void* self, const char* api_name, nertc_error_code error_code, const char* msg);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_network_type_changed)(void* self, nertc_network_type new_type);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_leave_channel)(void* self, nertc_error_code result, uint64_t channel_id);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_audio_device_routing_did_change)(void* self, nertc_audio_output_routing routing);
    /**
    * @if English
    * Occurs when the state of the audio device changes.
    * @param device_id    Device ID.
    * @param device_type  The type of the device. For more information, see nertc_audio_device_type_t.
    * @param device_state The state of the audio device.
    * @endif
    * @if Chinese
    * 音频设备状态更改的回调。
    * @param device_id     设备ID。
    * @param device_type   音频设备类型。详细信息请参考 nertc_audio_device_type_t。
    * @param device_state  音频设备状态。
    * @endif
    */
    void (NERTC_CALL *on_audio_device_state_changed)(void* self,const char* device_id,nertc_audio_device_type device_type,nertc_audio_device_state device_state);  
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_audio_default_device_changed)(void* self, const char* device_id, nertc_audio_device_type device_type);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_video_device_state_changed)(void* self,const char* device_id,nertc_video_device_type device_type,nertc_video_device_state device_state);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_camera_focus_changed)(void* self, const struct nertc_camera_focus_and_exposure_info* info);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_camera_exposure_changed)(void* self, const struct nertc_camera_focus_and_exposure_info* info);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_capture_video_frame)(void* self,
                                             void* data,
    ...
    * status code knertc_audio_mixing_state_tFinished, and the error_code parameter contains kNERtcAudioMixingErrorOK.
    * - If an error occurs in the playback, the knertc_audio_mixing_state_tFailed status code is returned, and the error_code
    ...
    * @param state         The playback state of the music file. For more information, see #nertc_audio_mixing_state_t.
    * @param error_code    The error code. For more information, see #nertc_audio_mixing_error_code_t.
    * @endif
    * @if Chinese
    * 本地用户的音乐文件播放状态改变回调。
    * <br>调用 startAudioMixing 播放混音音乐文件后，当音乐文件的播放状态发生改变时，会触发该回调。
    * - 如果播放音乐文件正常结束，state 会返回相应的状态码 knertc_audio_mixing_state_tFinished，error_code 返回
    * kNERtcAudioMixingErrorOK。
    * - 如果播放出错，则返回状态码 knertc_audio_mixing_state_tFailed，error_code 返回相应的出错原因。
    * - 如果本地音乐文件不存在、文件格式不支持、无法访问在线音乐文件 URL，error_code都会返回 kNERtcAudioMixingErrorCanNotOpen。
    * @param state         音乐文件播放状态，详见 #nertc_audio_mixing_state_t.
    * @param error_code    错误码，详见 #nertc_audio_mixing_error_code_t.
    * @endif
    */
    void (NERTC_CALL *on_audio_mixing_state_changed)(void* self,
                                    nertc_audio_mixing_state state,
                                    nertc_audio_mixing_error_code error_code);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_audio_mixing_timestamp_update)(void* self, uint64_t timestamp_ms);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_audio_effect_timestamp_update)(void* self, uint32_t effect_id, uint64_t timestamp_ms);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_audio_effect_finished)(void* self, uint32_t effect_id);
    /**
    * @if English
    ...
    * @param speakers          The array that contains the information about user IDs and volumes is nertc_audio_volume_info.
    ...
    * @param speakers          每个说话者的用户 ID 和音量信息的数组: nertc_audio_volume_info
    ...
    * @param task_id       The ID of a task.
    * @param url           The URL for the streaming task.
    * @param state         #nertc_live_stream_state_code_t The state of live stream-pushing.
    * - 505: Pushing.
    * - 506: Pushing fails.
    * - 511: Pushing ends.
    * @endif
    ...
    * @param task_id       任务id
    * @param url           推流地址
    * @param state         #nertc_live_stream_state_code_t, 直播推流状态
    * - 505: 推流中；
    * - 506: 推流失败；
    * - 511: 推流结束；
    * @endif
    ...
    * @endif
    */
    void (NERTC_CALL *on_audio_howling)(void* self, bool howling);  
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_audio_recording)(void* self, nertc_audio_recording_code code, const char* file_path);
    /**
    * @if English
    ...
    * 跨房间媒体流转发状态发生改变回调。
    * @since V4.3.0
    * @param state         当前跨房间媒体流转发状态。详细信息请参考 #nertc_channel_media_relay_state_t
    ...
    * 媒体流相关转发事件回调。
    * @since V4.3.0
    * @param event         当前媒体流转发事件。详细信息请参考 #nertc_channel_media_relay_event_t 。
    * @param channel_name  转发的目标房间名。
    * @param error         相关错误码。详细信息请参考 #nertc_error_code_t 。
    * @endif
    */
    ...
    * @endif
    */
    void (NERTC_CALL *on_publish_fallback_to_audio_only)(void* self, bool is_fallback, nertc_video_stream_type type);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_subscribe_fallback_to_audio_only)(void* self,
                                                    nertc_uid_t uid,
                                                    bool is_fallback,
    ...
    * @endif
    */
    void (NERTC_CALL *on_lastmile_quality)(void* self, nertc_network_quality_type quality);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_lastmile_probe_result)(void* self, const struct nertc_lastmile_probe_result* result);
    /**
    * @if English
    ...
    * @endif
    */
    void (NERTC_CALL *on_check_necast_audio_driver_result)(void* self, nertc_install_cast_audio_driver_result result);
    ...
    * @endif
    */
    void (NERTC_CALL *on_virtual_background_source_enabled)(void* self, bool enabled, nertc_virtual_background_source_state_reason reason);
    ...
    * @endif
    */
    void (NERTC_CALL *on_local_video_watermark_state)(void* self, nertc_video_stream_type type, nertc_local_video_watermark_state state);
    ...
    * @endif
    */
    void (NERTC_CALL *on_update_permission_key)(void* self, const char* key, nertc_error_code error, int timeout);
    ...
    * @endif
    */
    void (NERTC_CALL *on_user_data_receive_message)(void* self, nertc_uid_t uid, const char* source_id, void* data, uint64_t size);
    ...
    * @endif
    */
    void (NERTC_CALL *on_user_data_start)(void* self, nertc_uid_t uid);
    ...
    * @endif
    */
    void (NERTC_CALL *on_user_data_stop)(void* self, nertc_uid_t uid);
    ...
    * @endif
    */
    void (NERTC_CALL *on_user_data_state_changed)(void* self, nertc_uid_t uid, const char* source_id);
    ...
    * @endif
    */
    void (NERTC_CALL *on_user_data_buffered_amount_changed)(void* self, nertc_uid_t uid, const char* source_id, uint64_t previous_amount);
};

NERTC_END_DECLS

#endif  // NERTC_ENGINE_EVENTS_H
