#ifndef NERTC_VIDEO_MANAGER_H
#define NERTC_VIDEO_MANAGER_H
 ...
 * @endif
 */
NERTC_API struct nertc_device_collection* NERTC_CALL nertc_video_device_manager_enumerate_capture_devices(struct nertc_video_device_manager* self);
/**
* @if Chinese
* 指定视频采集设备。
...
*      <td>视频采集设备的设备 ID。可以通过 \ref IVideoDeviceManager::enumerateCaptureDevices "enumerateCaptureDevices"
* 接口获取。</td>
*  </tr>
*  <tr>
*      <td>type</td>
...
* @endif
*/
NERTC_API int NERTC_CALL nertc_video_device_manager_set_device(struct nertc_video_device_manager* self, nertc_video_stream_type type, const char* device_id);
...
* 可以通过 IVideoDeviceManager 接口获取device_id nertc::NERtcVideoStreamType type =
* nertc::NERtcVideoStreamType::kNERTCVideoStreamMain; setDevice(device_id.c_str(), type);
* //获取辅流通道的设备信息
* std::string device_id = "\\?\usb#vid_046d&pid_081b&mi_00#7&1f6973a&0&0000#{65e8773d-8f56-11d0-a3b9-00a0c9223196}\global"; //
* 可以通过 IVideoDeviceManager 接口获取device_id nertc::NERtcVideoStreamType type =
* nertc::NERtcVideoStreamType::kNERTCVideoStreamSub setDevice(device_id.c_str(), type);
* @endcode
* @return
* - 0（kNERtcNoError）：方法调用成功。
* - 其他：方法调用失败。
...
* @endif
*/
NERTC_API int NERTC_CALL nertc_video_device_manager_get_device(struct nertc_video_device_manager* self, nertc_video_stream_type type, char* device_id);

NERTC_END_DECLS

#endif  // NERTC_VIDEO_MANAGER_H
