 ...
 * @endif
 */
typedef void (*onFrameDataCallback)(uid_t uid,
                                    void* data,
                                    uint32_t type,
                                    uint32_t width,
                                    uint32_t height,
 ...
 * <br>Some APIs allow you to modify the content that void *data points to in the frame. However, you cannot modify the format.
...
struct NERtcJoinChannelOptions {
    ...
    */
    ...
    NERtcJoinChannelOptions() : permission_key(NULL), team_id(-1), mode(kNERtcRangeAudioModeDefault), audible_distance(-1) {
...
struct NERtcJoinChannelOptionsEx {
    ...
    */
    ...
    NERtcJoinChannelOptionsEx() : permission_key(NULL), team_id(-1), mode(kNERtcRangeAudioModeDefault), audible_distance(-1) {
      memset(custom_info, 0, sizeof(custom_info));
    }
};
...
struct NERtcPositionInfo {
  ...
  NERtcPositionInfo() {
    memset(speaker_position, 0, sizeof(speaker_position));
    memset(speaker_quaternion, 0, sizeof(speaker_quaternion));
    memset(head_position, 0, sizeof(head_position));
    memset(head_quaternion, 0, sizeof(head_quaternion));
  }
};
