...
<table>
  ...
  <tr>
    ...
    <td>开启屏幕共享，共享范围为指定屏幕的指定区域。该方法仅适用于 macOS 平台。</td>
    <td>V3.5.0 (Linux 暂不支持)</td>
  </tr>
  <tr>
