...
void JoinWidget::setUi()
{
    ...
    //
    open_1v1_ = new QCheckBox(central_widget);
    open_1v1_->setText(u8"1v1");
    open_1v1_->setGeometry(QRect(70, 295, 161, 31));
    open_1v1_->setChecked(true);
...
void JoinWidget::onBtnJoinClicked()
{
    ...
    join_info.open_1v1_ = open_1v1_->isChecked();
